...
| <span style="font-size:10px;">GHSL population</span> | <span style="font-size:10px;">Extract population by points</span> | <span style="font-size:10px;">500m buffers based on points</span> |
|------------------------------|--------------------------------------------|-------------------------------------------|
...
| <span style="font-size:10px;">Population-Weighted Greenspace Fraction</span> | <span style="font-size:10px;">Summarize values with grid</span> | <span style="font-size:10px;">Population-Weighted Greenspace Exposure</span> |
|--------------------------------------------|--------------------------------------|---------------------------------------------|
